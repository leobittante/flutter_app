...
class GetFilmCommonUseCase extends UseCase<ResponseFilmEntity, Params> {

  final IFilmSearchRepository filmSearchRepository;
  GetFilmCommonUseCase(this.filmSearchRepository);

  @override
  Future<Either<SearchException, ResponseFilmEntity>> call(params) async {
    return await filmSearchRepository.getFilmsCommon(params.page);
  }
}
